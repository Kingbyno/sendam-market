...
export function SellerForm({ categories }: { categories: CategoryWithChildren[] }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select name="condition" onValueChange={setCondition} required>
                ...
                <SelectContent>
                  <SelectItem value="NEW">Brand New - Never used, still in original packaging</SelectItem>
                  <SelectItem value="LIKE_NEW">Like New - Barely used, excellent condition</SelectItem>
                  <SelectItem value="GOOD">Good - Used but well-maintained, minor wear</SelectItem>
                  <SelectItem value="FAIR">Fair - Used with visible wear, fully functional</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
      ...
      <div className="space-y-6 pt-4">
        ...
        <div className={`p-6 rounded-xl border-2 transition-all duration-300 ${
          ...
          <Button 
            ...
            className={`w-full h-14 text-lg font-bold shadow-lg transition-all duration-200 ${
              termsAccepted && !isSubmitting
          ...
          <p className={`text-center text-sm mt-3 font-medium ${
            termsAccepted ? "text-gray-600" : "text-red-600"
          }`}>
            {termsAccepted 
